/* Rina's 2048 UI v71 — Direction A gameplay/staging integration. */
(function () {
  "use strict";
  ...
  function mpScene(mode) {
    if (mode === "freeplay") {
      return '<div class="mp-freeplay-scene">' +
        ...
        '<div class="mp-freeplay-guide" aria-label="Movement controls and one-step Undo">' +
          '<div class="mp-freeplay-guide-row"><span class="mp-freeplay-guide-copy"><b>MOVE</b><small>Play normally</small></span>' + mpMovementKeysMarkup() + '</div>' +
          '<div class="mp-freeplay-guide-row undo"><span class="mp-freeplay-guide-copy"><b>UNDO</b><small>One step</small></span><kbd>Z</kbd></div>' +
        '</div>' +
      '</div>';
    }
