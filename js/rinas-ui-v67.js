  ...
  function mpScene(mode) {
    if (mode === "freeplay") {
      return '<div class="mp-freeplay-scene">' +
        ...
        '<div class="mp-freeplay-guide" aria-label="Make a move, then use Z for a one-step Undo">' +
          '<span class="mp-freeplay-guide-step move"><span class="mp-freeplay-guide-icon" aria-hidden="true">' + assetIcon("move") + '</span><span><b>Move</b><small>Play normally</small></span></span>' +
          '<span class="mp-freeplay-guide-arrow" aria-hidden="true">→</span>' +
          '<span class="mp-freeplay-guide-step undo"><kbd>Z</kbd><span><b>Undo</b><small>One step</small></span></span>' +
        '</div>' +
      '</div>';
    }
