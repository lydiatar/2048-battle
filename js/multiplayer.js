...
// Hide the normal game until a multiplayer match starts.
...
lobby.innerHTML = ` <div class="lobby-box"> <h1>2048 Battle</h1> <p class="lobby-subtitle">First player to reach 2048 wins!</p>
...
status.innerHTML =
"Your room code is:<br><strong style="font-size: 32px; letter-spacing: 5px;">" +
roomCode +
"</strong><br><br>Send this code to your opponent.<br>Waiting for them to join...";
