    ...
    stage.innerHTML =
      '<div class="mp-live-left">' +
        ...
        '<div class="mp-mode-rail">' +
          '<button class="mp-live-mode is-active" type="button" data-mode="race"><span class="mp-mode-icon" aria-hidden="true">' + assetIcon("tile-race") + '</span><span class="mode-index">01</span><span><strong>Tile Race</strong><small>Reach the target first. No Undo.</small></span><span class="mode-chevron">›</span></button>' +
