/* Rina's 2048 UI v70 — preview geometry lock; behavior from v69. */
(function () {
  "use strict";
    ...
    if (mode === "freeplay") {
      return '<div class="mp-freeplay-scene">' +
        ...
        '<div class="mp-freeplay-guide" aria-label="Movement controls and one-step Undo">' +
          '<span class="mp-freeplay-guide-step move"><span class="mp-freeplay-guide-copy"><b>Move</b><small>Play normally</small></span>' + mpMovementKeysMarkup() + '</span>' +
          '<span class="mp-freeplay-guide-divider" aria-hidden="true"></span>' +
          '<span class="mp-freeplay-guide-step undo"><span class="mp-freeplay-guide-copy"><b>Undo</b><small>One step</small></span><kbd>Z</kbd></span>' +
        '</div>' +
      '</div>';
    }
